...
from networks.raft.update import BasicUpdateBlock, SmallUpdateBlock
from networks.raft.extractor import BasicEncoder, SmallEncoder
from networks.raft.corr import CorrBlock, AlternateCorrBlock
from networks.raft.utils.utils import bilinear_sampler, coords_grid, upflow8
...
class RAFT(nn.Module):
    def __init__(self, small=False, alternate_corr=False, mixed_precision=False):
